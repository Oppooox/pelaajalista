...
function UpdatePlayerTable(connectedPlayers)
	...
	local ems, police, taxi, mechanic, cardealer, junk, players = 0, 0, 0, 0, 0, 0, 0
	...
	SendNUIMessage({
		...
		jobs   = {ems = ems, police = police, taxi = taxi, mechanic = mechanic, junk = junk, player_count = players}
	})
end
